...
BLOG_URL = "https://www.slowspinsociety.com/newsletter"
FEED_URL = "https://www.slowspinsociety.com/newsletter/?format=rss"
...
def first_article_url():
    ...
    for a in soup.select("a[href]"):
        ...
        if not href or not text:
            continue
        if "/newsletter/" in href and text != "Read More":
